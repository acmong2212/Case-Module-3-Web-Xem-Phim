...
<div class="header">
  <div class="container">
    ...
    <form action="/premium?checkKeyCode=${acc.getNameUser()}" method="post">
    <div class="w3l_sign_in_register">
      <ul>
      <c:choose>
        <c:when test="${acc.getIsAdmin() == 1}">
          <a>Hello ${acc.getNameUser()}</a>
          <a href="/admin?action=viewManager" class="btn btn-secondary">Manager</a>
         <button><a href="/" class="btn btn-dark">Log Out</a></button>
        </c:when>
        <c:when test="${acc.getIsUser() == 1}">
          <p name="checkKeyCode" value="${acc.getNameUser()}">Hello ${acc.getNameUser()}</p>
          <div class="container">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h4 class="modal-title">Neu ban co key code? Hay nhap vao day de tro thanh VIP</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>

                  <!-- Modal body -->
                  <div class="modal-body">
                    <input  type="text" placeholder="Nhap code" name="keyCode">
                  </div>

                  <!-- Modal footer -->
                  <div class="modal-footer">
                    <button  type="submit" class="btn btn-second ary">Submit</button>
  ...
  <div class="container">
    <div class="w3_agile_banner_bottom_grid">
      <div id="owl-demo" class="owl-carousel owl-theme">
        ...
        <div class="item">
          <div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
            <a href="/view/single.jsp" class="hvr-shutter-out-horizontal"><img src="/images/m15.jpg" title="album-name" class="img-responsive" alt=" " />
              <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
            </a>
            <div class="mid-1 agileits_w3layouts_mid_1_home">
              <div class="w3l-movie-text">
                <h6><a href="/view/single.jsp">God’s Compass</a></h6>
              </div>
              <div class="mid-2 agile_mid_2_home">
                <p>2016</p>
                <div class="block-stars">
          ...
          <div class="w3_agile_featured_movies">
            <c:forEach var="m" items="${movies}">
              <div class="col-md-2 w3l-movie-gride-agile">
                <a href="single.html" class="hvr-shutter-out-horizontal"><img src="${m.image}" title="album-name" class="img-responsive" alt="Not found " />
                  <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
                </a>
                <div class="mid-1 agileits_w3layouts_mid_1_home">
                  <div class="w3l-movie-text">
                    <h6><a href="single.html">${m.nameMovie}</a></h6>
                  </div>
                  <div class="mid-2 agile_mid_2_home">
                    <p>${m.year}</p>
                    <div class="block-stars">
