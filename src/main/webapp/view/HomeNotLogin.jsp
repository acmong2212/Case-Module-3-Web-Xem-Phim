...
<html lang="en">
<head>
  <title>Thang Tu film studio</title>
  <!-- for-mobile-apps -->
...
<div class="header">
  <div class="container">
    ...
    <div class="w3l_sign_in_register">
      <ul>
        <li><i class="fa fa-phone" aria-hidden="true"></i> (+84) 33 542 8587</li>
          ...
          <div class="w3_login_module">
            <div class="module form-module">
              ...
              <div class="form">
                ...
                <form action="/user?action=login" method="post">
                  ...
                  <c:choose>
                    ...
                    <c:when test='${requestScope["messLogin"] != null}'>
                      <p><span class="message">${requestScope["messLogin"]}</span></p>
                    </c:when>
                    <c:when test='${requestScope["mess2"] != null}'>
                      <p><span class="message">${requestScope["mess2"]}</span></p>
                    </c:when>
              ...
              <div class="form">
                ...
                <form action="/user?action=sign" method="post">
                  <input type="text" name="Username" placeholder="Username" required="">
                  <input type="password" name="Password" placeholder="Password" required="">
                  <input type="password" name="Verification" placeholder="Password Verification" required="">
                  <input type="text" name="Phone" placeholder="Phone Number" required="">
                  <c:choose>
                    <%--pass1 khac pass2--%>
                    <c:when test='${requestScope["mess"] != null}'>
                      <p><span class="message">${requestScope["mess"]}</span></p>
                    </c:when>

                    <%--trung name trong db--%>
                    <c:when test='${requestScope["mess1"] != null}'>
                      <p><span class="message">${requestScope["mess1"]}</span></p>
                    </c:when>
        ...
        <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
          <div class="w3_agile_featured_movies">
            ...
            <div class="col-md-2 w3l-movie-gride-agile">
              <a href="single.html" class="hvr-shutter-out-horizontal"><img src="${m.image}" title="album-name" class="img-responsive" alt=" " />
                <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
              </a>
              <div class="mid-1 agileits_w3layouts_mid_1_home">
                <div class="w3l-movie-text">
